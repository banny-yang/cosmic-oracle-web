  ...
  head: () => ({
    ...
    meta: [
      { title: "典籍馆 · 起名用的国学典籍书目 · 对脉名鉴" },
      {
        name: "keywords",
        content:
          "诗经取名,楚辞取名,唐诗取名,宋词取名,宋诗取名,宋文名句,魏晋文取名,战国策取名,山海经取名,水经注取名,本草纲目取名,三字经取名,千字文取名,论语取名,周易取名,典籍取名,国学典籍",
      },
      ...
      { property: "og:title", content: "典籍馆 · 起名用的国学典籍书目" },
      {
        name: "description",
        content:
          "对脉名鉴典籍馆：起名引擎收录的国学典籍书目，逐部列出简介、原文句数与代表名句（诗经、楚辞、唐诗宋词、宋诗宋文、魏晋文、战国策、山海经、水经注、本草纲目、蒙学等），可指定其中一部为宝宝取名。",
      },
      {
        property: "og:description",
        content:
          "诗经、楚辞、唐诗宋词、宋诗宋文、魏晋文、战国策、山海经、水经注、本草纲目等国学典籍书目与代表名句，可按书取名、出处全书一致。",
      },
